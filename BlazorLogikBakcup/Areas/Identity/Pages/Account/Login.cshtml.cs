...
namespace BlazorProyectoPostres.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<ApplicationUser> _signInManager; // Cambiado aquí

        public LoginModel(SignInManager<ApplicationUser> signInManager) // Cambiado aquí
        {
